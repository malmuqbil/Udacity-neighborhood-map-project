  ...
  function populateInfoWindow(marker, infowindow) {
    if (infowindow.marker != marker) {
      ...
      var forSquareUrl = 'https://api.foursquare.com/v2/venues/search?v=' + version + '&ll=' + marker.position.lat() + ',' + marker.position.lng() + '&intent=checkin&' + '&client_id=' + CLIENT_ID + '&client_secret=' + CLIENT_SECRET;
      $.ajax({
        url: forSquareUrl,
        dataType: 'json'
      }).done(function(data) {
